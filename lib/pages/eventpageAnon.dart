...
class EventPageAnon extends StatefulWidget {
  SubCategory? subCategory;

  EventPageAnon({Key? key}) : super(key: key);

  @override
  _EventPageAnonState createState() => _EventPageAnonState();
}

class _EventPageAnonState extends State<EventPageAnon> {
